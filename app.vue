<template>
    <div>
        ...
        <div id="trailer" class="fixed inset-0 z-10000 w-4 h-4 backdrop-blur-xs grid place-items-center rounded-full pointer-events-none opacity-0 transition-all duration-200 ease-out">
